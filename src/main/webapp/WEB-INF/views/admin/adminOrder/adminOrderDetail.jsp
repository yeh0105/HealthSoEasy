...
-18 -50 -48 -42 -56 -59 -72 -67 -63 -6 5 15 47 42 84 22 30 0 39 -24 9z" />
		...
		<div class="app-content">
			<div class="app-content-header">
				<h1 class="app-content-headerText">Order Detail</h1>
				<!--       月亮 -->
          ...
          <path d="M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z"></path>
			...
			<section class="my-80 rmy-500">
				<div class="container">
					...
					<h5 class="header-title text-lg-center">訂單編號#
						${orderDetail.orderId} 詳情</h5>
					<div class="login-information bg-white">
						...
						<table class="table table-border">
							...
							<tbody>
								...
								<c:forEach var="orderDetail" items="${orderDetail.orderDetail}">
									<c:set var="total"
										value="${total+orderDetail.orderItemQuantity*orderDetail.productPrice}"></c:set>
								...
								<tr>
									<td colspan="1" class="text-lg-center">Total:</td>

									<td colspan="" class="text-lg-center">&nbsp;$${total}
										&nbsp;(不含運費)</td>
								<tr />
							</tbody>
						...
						<div>
							...
							<!-- /.card-body -->
							<div class="card-body">
						 <a href="<c:url value="/admin/adminManage/adminOrder"/>">
										<button class="btn btn-danger">
											<i class="fa fa-trash-o"></i>&nbsp;關閉訂單
										</button>
									</a>
								</div>
        ...
        ============
			...
			<div>
				<a
					href="<c:url value="/admin/adminManageadminOrder/payStatus/${orderDetail.orderId}"/>"
					style="background-color: transparent; font-color: #FFFFFF; padding-right: 0px"><span>&nbsp;&nbsp;&nbsp;</span>
				</a>
			</div>
			...
			<script src="js/mall/malladmin/mallorder.js"></script>
</body>
</html>