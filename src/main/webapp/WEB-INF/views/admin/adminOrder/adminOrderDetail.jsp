...
<!--         <img src="https://images.unsplash.com/photo-1527736947477-2790e28f3443?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTE2fHx3b21hbnxlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=900&q=60" alt="Account"> -->
  ...
  <div class="app-content">
          ...
          <path d="M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z"></path>
			...
			<div>
				<a class="" href="<c:url value="/admin/adminManage/adminOrder"></c:url>">回上一頁</a>
			</div>
			<br>
                    ...
                    <div class="card-body">
                        <div class="grid-btn">
                            <button class="btn btn-info" onclick="orderEdit()"><i
                                    class="fa fa-pencil-square-o"></i>&nbsp;修改訂單
                            </button>
                          <a href="<c:url value="/admin/adminManage/adminOrder/status/${orderDetail.orderId}"/>"> <button class="btn btn-info" onclick="orderCheckDone()"><i
                                    class="fa fa-truck"></i>&nbsp;配送完成 </button></a>
                           
                            <button class="btn btn-info" onclick="orderCheckOut()"><i
                                    class="fa fa-truck"></i>&nbsp;出貨
                            </button>
                            <button class="btn btn-danger" onclick="closeOrder()"><i
                                    class="fa fa-trash-o"></i>&nbsp;關閉訂單
                            </button>
                        </div>
