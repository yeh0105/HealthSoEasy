...
<!--         <img src="https://images.unsplash.com/photo-1527736947477-2790e28f3443?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTE2fHx3b21hbnxlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=900&q=60" alt="Account"> -->
  ...
  <div class="app-content">
    <div class="app-content-header">
      <h1 class="app-content-headerText">Nutritionist</h1>
<!--       月亮 -->
...
<!--  --------------------------- ----表頭欄位--------------------------- -->
      ...
      <div class="products-header">
        ...
        <div class="product-cell sales">Degree<button class="sort-button">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512"><path fill="currentColor" d="M496.1 138.3L375.7 17.9c-7.9-7.9-20.6-7.9-28.5 0L226.9 138.3c-7.9 7.9-7.9 20.6 0 28.5 7.9 7.9 20.6 7.9 28.5 0l85.7-85.7v352.8c0 11.3 9.1 20.4 20.4 20.4 11.3 0 20.4-9.1 20.4-20.4V81.1l85.7 85.7c7.9 7.9 20.6 7.9 28.5 0 7.9-7.8 7.9-20.6 0-28.5zM287.1 347.2c-7.9-7.9-20.6-7.9-28.5 0l-85.7 85.7V80.1c0-11.3-9.1-20.4-20.4-20.4-11.3 0-20.4 9.1-20.4 20.4v352.8l-85.7-85.7c-7.9-7.9-20.6-7.9-28.5 0-7.9 7.9-7.9 20.6 0 28.5l120.4 120.4c7.9 7.9 20.6 7.9 28.5 0l120.4-120.4c7.8-7.9 7.8-20.7-.1-28.5z"/></svg>
          </button></div>
...
<!--           </button></div> -->
        <div class="product-cell price">Email<button class="sort-button">
          ...
          <div class="product-cell price">Category<button class="sort-button">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 512 512"><path fill="currentColor" d="M496.1 138.3L375.7 17.9c-7.9-7.9-20.6-7.9-28.5 0L226.9 138.3c-7.9 7.9-7.9 20.6 0 28.5 7.9 7.9 20.6 7.9 28.5 0l85.7-85.7v352.8c0 11.3 9.1 20.4 20.4 20.4 11.3 0 20.4-9.1 20.4-20.4V81.1l85.7 85.7c7.9 7.9 20.6 7.9 28.5 0 7.9-7.8 7.9-20.6 0-28.5zM287.1 347.2c-7.9-7.9-20.6-7.9-28.5 0l-85.7 85.7V80.1c0-11.3-9.1-20.4-20.4-20.4-11.3 0-20.4 9.1-20.4 20.4v352.8l-85.7-85.7c-7.9-7.9-20.6-7.9-28.5 0-7.9 7.9-7.9 20.6 0 28.5l120.4 120.4c7.9 7.9 20.6 7.9 28.5 0l120.4-120.4c7.8-7.9 7.8-20.7-.1-28.5z"/></svg>
          </button>
        </div>
	...
	<!--       ----------------------一筆資料內容--開始--------------------- -->
     <c:forEach var='nutritionist' items='${nutritionists}'> 
      ...
      <div class="products-row">
        ...
        <div class="product-cell price"><span class="cell-label">Gender :</span>${nutritionist.nutritionistGender == 'F' ? "女性" : "男性"}</div>
        <div class="product-cell sales"><span class="cell-label">Degree :</span>${nutritionist.nutritionistDegree}</div>
        <div class="product-cell price"><span class="cell-label">Email :</span>${nutritionist.nutritionistEmail}</div>
        <div class="product-cell status-cell">
          <span class="cell-label">Category :</span>
          <span class="status active">${nutritionist.nutritionistCategory}</span>
        </div>
         <div class="product-cell price"><a	href="<c:url value='/admin/adminManage/adminNutritionist/up/${nutritionist.nutritionistId}' />"><button class="app-content-headerButton">Update</button></a></div>
                  
         <div class="product-cell price"><a	class='deleteSportMap' href="<c:url value='/admin/adminManage/adminNutritionist/del/${nutritionist.nutritionistId}' />"><button class="app-content-headerButton">Delete</button></a></div>
