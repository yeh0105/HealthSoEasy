...
<link href="${pageContext.request.contextPath}/css/admin.css"
	rel="stylesheet">
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/mall/malladmin/mall-bootstrap.min.css"
	type="text/css">
...
-18 -50 -48 -42 -56 -59 -72 -67 -63 -6 5 15 47 42 84 22 30 0 39 -24 9z" />
		...
		<div class="app-content">
			<div class="app-content-header">
				<h1 class="app-content-headerText">Products Management</h1>
				<!--       月亮 -->
          ...
          <path d="M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z"></path>
				...
				<!--   ===================  新增 =========================================================================-->
				<a href="<c:url value='/admin/adminManage/add'/>">
			...
			<div class="app-content-actions">
				...
				<div style="width: 500px">
					<form action="<c:url value='/admin/adminManage/adminProduct/1'/>">
						<input type="hidden" name="sortField" value="${sortField}" /> <input
							type="hidden" name="sortDir" value="${sortDir}" /> <input
							class="search-bar" placeholder="Search..." type="text"
							name="keyword" value="${keyword}" required /> <input
			...
			<div class="products-area-wrapper tableView">
				...
				<div class="products-header">
					<div class="product-cell image">
						產品編號 <a
							href="<c:url value='/admin/adminManage/adminProduct/${currentPage}?sortField=productId&sortDir=${reverSortDir}'/>">
					...
					<div class="product-cell category">
						Category<a
							href="<c:url value='/admin/adminManage/adminProduct/${currentPage}?sortField=category&sortDir=${reverSortDir}'/>">
							<button class="sort-button">
								<svg xmlns="http://www.w3.org/2000/svg" width="5" height="16"
									viewBox="0 0 512 512">
									<path fill="currentColor"
					...
					<div class="product-cell sales">
						Price <a
							href="<c:url value='/admin/adminManage/adminProduct/${currentPage}?sortField=productPrice&sortDir=${reverSortDir}'/>">
							<button class="sort-button">
								<svg xmlns="http://www.w3.org/2000/svg" width="5" height="16"
									viewBox="0 0 512 512">
									<path fill="currentColor"
					...
					<div class="product-cell stock">
						Cost<a
							href="<c:url value='/admin/adminManage/adminProduct/${currentPage}?sortField=productCost&sortDir=${reverSortDir}'/>">
							<button class="sort-button">
								<svg xmlns="http://www.w3.org/2000/svg" width="5" height="16"
									viewBox="0 0 512 512">
									<path fill="currentColor"
					...
					<div class="product-cell status-cell">
						Amount<a
							href="<c:url value='/admin/adminManage/adminProduct/${currentPage}?sortField=productAmount&sortDir=${reverSortDir}'/>">
							<button class="sort-button">
								<svg xmlns="http://www.w3.org/2000/svg" width="5" height="16"
									viewBox="0 0 512 512">
									<path fill="currentColor"
					...
					<div class="product-cell status-cell">
						Date<a
							href="<c:url value='/admin/adminManage/adminProduct/${currentPage}?sortField=productDate&sortDir=${reverSortDir}'/>">
							<button class="sort-button">
								<svg xmlns="http://www.w3.org/2000/svg" width="5" height="16"
									viewBox="0 0 512 512">
									<path fill="currentColor"
					...
					<div class="product-cell status-cell">
						Shop<a
							href="<c:url value='/admin/adminManage/adminProduct/${currentPage}?sortField=shopBean.shopId&sortDir=${reverSortDir}'/>">
<button class="sort-button">
								<svg xmlns="http://www.w3.org/2000/svg" width="5" height="16"
									viewBox="0 0 512 512">
									<path fill="currentColor"
					...
					<div class="products-row">
						...
						<div class="product-cell image">
							...
							<div class="product-img">
								<div id="imgUploadbtn">
									<a href="<c:url value='/admin/adminManage/UploadProductImg/${product.productId}'/>"><img alt=""
										src="${pageContext.request.contextPath}/admin/adminManage/getProductImage/${product.productId}"></a>
						...
						<div class="product-cell category">
							<span class="cell-label">Name:</span><a
								href="<c:url value='/mall/lists/product/${product.productId}'/>">
						...
						<div class="product-cell price">
							<a
								href="<c:url value='/admin/adminManage/adminUpdate/${product.productId}'/>"><button
									class="app-content-headerButton">Update</button></a>
						</div>
			...
			<!-- ---------------------------控制分頁用----------------------------------- -->
			<br> <span>產品總數:<c:out value="${totalItems}" /></span>
				...
				<ul class=pager>
					...
					<li class=previous><c:choose>
							<c:when test="${currentPage > 1}">
								<a
									href="<c:url value='/admin/adminManage/adminProduct/${currentPage - 1}?sortField=${sortField}&sortDir=${sortDir}'/>">Previous</a>
							</c:when>
							<c:otherwise>
								<a>Previous</a>
							</c:otherwise>
					...
					<li class=next><c:choose>
							<c:when test="${currentPage < totalPages}">
								<a
									href="<c:url value='/admin/adminManage/adminProduct/${currentPage + 1}?sortField=${sortField}&sortDir=${sortDir}'/>">Next</a>
							</c:when>
							<c:otherwise>
								<a>Next</a>
							</c:otherwise>
	...
	<script type="text/javascript">
		function clearFilter() {
			window.location = '/soeasy/admin/adminManage/adminProduct/';
		}
	</script>
