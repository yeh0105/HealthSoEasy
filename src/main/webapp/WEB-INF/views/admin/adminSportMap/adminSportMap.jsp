...
<!--       新增 -->
      ...
      <button class="app-content-headerButton">新增地點</button></a>
    </div>
     ...
     <c:forEach  varStatus="stVar" var='sportMap' items='${sportMaps}'> 
      ...
      <div class="products-row">
        <button class="cell-more-button">
          ...
          <div class="product-cell image">
            <img src="${pageContext.request.contextPath}/images/sportMap/MapIcon.png" alt="sport">
        ...
        <div class="product-cell sales"><span class="cell-label">Info</span>${fn:substring(sportMap.value.sportMapInfo,0,10)}...</div>
