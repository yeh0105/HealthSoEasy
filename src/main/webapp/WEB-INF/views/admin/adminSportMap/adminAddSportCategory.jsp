...
<div>
		<fieldset style="width: 900px;background-color: #f2f2f2;border-radius: 20px;">
			<legend style="color:#3a7ca5;font-weight: bold;font-size: large;margin-bottom: 20px;">新增分類</legend>
			...
			<table>
				...
				<tr>
					<td>分類名稱：</td>
					<td width='600'><form:input path='sportCategoryName' /> 
					<form:errors path="sportCategoryName" cssClass="error" />
					</td>
				</tr>	
