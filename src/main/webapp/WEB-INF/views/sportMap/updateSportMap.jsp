	...
	<div id="">
		<fieldset style="width:700px;">
			...
			<table >
				...
				<td>分類：</td>
				<td>
				<form:select path="sportMapBean.sportCategoryBean">
				<form:option value="-1" label="請挑選" />
				<form:options items="${sportCategoryBeanList}" 
				itemLabel='sportCategoryName' itemValue='sportCategoryId'/>
				</form:select>
				<form:errors path="sportCategory" cssClass="error" />
				</td>				
				</tr>
				<tr>
				
				<td>運動地點名稱：</td>
				<td width ='200'><form:input path='sportMapBean.sportMapName'/><br>
				<form:errors path='sportMapName' cssClass="error"/>	
				</tr>
				<tr>
				
				<td>地址：</td>
				<td width ='200'><form:input path='sportMapBean.sportMapAddress'/><br>
				<form:errors path='sportMapAddress' cssClass="error"/>	
				
				</tr>
				<tr>
				<td>地點簡介：</td>
				<td width ='200'><form:input path='sportMapBean.sportMapInfo'/><br>
				<form:errors path='sportMapInfo' cssClass="error"/>	
				
				</tr>
				<tr>
				<td>地圖：</td>
				<td width ='200'><form:input path='sportMapBean.sportMapMap'/><br>
