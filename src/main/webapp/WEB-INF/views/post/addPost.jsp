...
<body>
	...
	<div>
		<div class="container-fluid"
			style="width: 80%; padding: 1% 5%; border: 2px solid lightslategray; border-radius: 10px; box-shadow: 3px 3px 12px lightgrey; margin-left: 5%; margin-top: 10%; margin-bottom: 3%;">
			<div class="row-fluid" style="text-align: center;">
				<h2 style="font-size: 25px;">新增文章</h2>
				<form:form method="POST" action="addPost" modelAttribute="postBean"
					...
					<div style="display:flex; border-bottom: 3px #3DCA79 dashed;background-color: #EBFAF1">
						<div style=" width: 50%; text-align:left;">
							<form:select path='postCategoryBean.postCategoryId'
								style=" width: 50%; font-size: 30px; border: none;background-color: #EBFAF1;">
							...
							<form:errors path="postCategoryBean" cssClass="error"
								style="font-size: 15px;width:25%;" />
						</div>
						<div style=" width: 50%;">
							<form:input path='postMultiImg' type="file"
								style=" width: 50%; font-size: 25px; margin-left: -70%;" />
							<form:errors path="postMultiImg" cssClass="error"
					...
					<div style="background-color: #EBFAF1; padding: 1%; text-align: left; margin-top:-0.5%;">
