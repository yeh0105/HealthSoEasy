...
<body>
	...
	<div class="container-fluid">
		<div class="row-fluid" style="width: 80%; padding-left: 10%;">
			<div class="span12">
				<div class="row-fluid">
					<div class="row-fluid" style="border-top: 7px solid #325b43; border-radius: 5px; padding-top: 5%;">
						<!-- 	<div class="span12"> -->
								...
								<div class="row-fluid" style="border-bottom: 4px #325b43 dotted; margin-bottom: 1%; padding-bottom: 1%;">
									<div class="span9">
										<div class="media">
											...
											<a class="pull-left" href="<c:url value='/PostController/getPicture/${post.postId}' />"> 
											<img class="media-object" style="width: 100px; height: 100px; border: 1px lightgrey dashed;"
												src="<c:url value='/PostController/getPicture/${post.postId}' />" alt='' />
											</a>
											<div class="media-body" style="line-height: 30px;">
												<h3 class="media-heading">${post.postTitle}
													&nbsp;
													<button class="btn-success">${post.postCategory}</button>
												</h3>
												${fn:substring(post.postContent,0,100)}... 
												<a href="<c:url value='/PostNeedLoginController/getPost/${post.postId}' />">
													>>>觀看更多 
												</a>
											</div>
										</div>
									...
									<div class="span2 text-right">
										...
										<p style="font-size: 15px; color: grey;">
											<br>
											<br> By ${post.customerBean.customerNickname} <br>
