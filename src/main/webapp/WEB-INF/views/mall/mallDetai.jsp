								...
								<div class="row">
									...
									<div class="col-xl-4 col-lg-6 col-sm-6">
										<div class="product">
											<div class="product-img-wrap">
												<img
													src="${pageContext.request.contextPath}/images/mall/default.png"
													alt="img">
											...
											<div class="product-content-wrap">
												<div class="product-content">
													<p>
														<a href="shop-details.html">Fresh Tomato <br>(1
															kg)
														</a>
													</p>
												</div>
									...
									<div class="col-xl-4 col-lg-6 col-sm-6">
										<div class="product">
											...
											<div class="product-content-wrap">
												<div class="product-content">
													<p>
														<a href="shop-details.html">Chashi Aromatic Chinigura
															Rice (1 Bag 5 kg)</a>
													</p>
												</div>
												<div class="product-action">
									...
									<div class="col-xl-4 col-lg-6 col-sm-6">
										<div class="product">
											...
											<div class="product-content-wrap">
												<div class="product-content">
													<p>
														<a href="shop-details.html">Golden Collection Unsalted
															Roasted Pumpkin ( </a>1ps)
													</p>
												</div>
												<div class="product-action">
													<a href="#" class="add-to-btn small-btn"> <i
									...
									<div class="col-xl-4 col-lg-6 col-sm-6">
										<div class="product">
											...
											<div class="product-content-wrap">
												<div class="product-content">
													<p>
														<a href="shop-details.html">Organic Yam/Sweet Potato <br>(1
															kg)
														</a>
													</p>
												</div>
									...
									<div class="col-xl-4 col-lg-6 col-sm-6">
										<div class="product">
											...
											<div class="product-content-wrap">
												<div class="product-content">
													<p>
														<a href="shop-details.html">Organic Cauliflower <br>(1kg)
														</a>
													</p>
												</div>
												<div class="product-action">
									...
									<div class="col-xl-4 col-lg-6 col-sm-6">
										<div class="product">
											...
											<div class="product-content-wrap">
												<div class="product-content">
													<p>
														<a href="shop-details.html">Christopher Ranch Organic
															Garlic (500g)</a>
													</p>
												</div>
												<div class="product-action">
									...
									<div class="col-xl-4 col-lg-6 col-sm-6">
										<div class="product">
											...
											<div class="product-content-wrap">
												<div class="product-content">
													<p>
														<a href="shop-details.html">Fresh Corn on the Cob,
															color varies, each</a>
													</p>
												</div>
												<div class="product-action">
									...
									<div class="col-xl-4 col-lg-6 col-sm-6">
										<div class="product">
											...
											<div class="product-content-wrap">
												<div class="product-content">
													<p>
														<a href="shop-details.html">Organic Granny Smith Apple
															(4ps)</a>
													</p>
												</div>
												<div class="product-action">
									...
									<div class="col-xl-4 col-lg-6 col-sm-6">
										<div class="product">
											...
											<div class="product-content-wrap">
												<div class="product-content">
													<p>
														<a href="shop-details.html">Organic Yellow Banana <br>(4ps)
														</a>
													</p>
												</div>
												<div class="product-action">
									...
									<div class="col-xl-4 col-lg-6 col-sm-6">
										<div class="product">
											...
											<div class="product-content-wrap">
												<div class="product-content">
													<p>
														<a href="shop-details.html">Danish Full Cream Milk
															Powder</a>
													</p>
												</div>
												<div class="product-action">
									...
									<div class="col-xl-4 col-lg-6 col-sm-6">
										<div class="product">
											...
											<div class="product-content-wrap">
												<div class="product-content">
													<p>
														<a href="shop-details.html">Valencia Juicing Oranges <br>(4ps)
														</a>
													</p>
												</div>
												<div class="product-action">
									...
									<div class="col-xl-4 col-lg-6 col-sm-6">
										<div class="product">
											...
											<div class="product-content-wrap">
												<div class="product-content">
													<p>
														<a href="shop-details.html">Organic Red Seedless
															Grapes (500g)</a>
													</p>
												</div>
												<div class="product-action">
															...
															<div class="row">
																...
																<div class="col-lg-6">
																	<div
																		...
																		<p>Sed egestas, ante et vulputate volutpat,
																			eropede semper est, vitluctus metus libero eu augue.
																			Morbi purus libero, faucibus adipiscing.</p>
